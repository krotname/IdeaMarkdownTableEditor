...
- Version: `5.5.0`
- ZIP: `build/MarkdownTableEditorIdea-5.5.0.zip`
- GitHub release: `https://github.com/krotname/IdeaMarkdownTableEditor/releases/tag/v5.5.0`
- Download URL: `https://github.com/krotname/IdeaMarkdownTableEditor/releases/download/v5.5.0/MarkdownTableEditorIdea-5.5.0.zip`
...
5. Upload `build/MarkdownTableEditorIdea-5.5.0.zip`.
