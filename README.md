...
- Автовыравнивание таблицы после правки без изменения ширины.
- Кнопки `Автовыравнивание` и `Автоподгонка` доступны в левом нижнем углу IDE, в статус-баре.
...
| `Auto Align After Edit`                        | Автоматически выравнивает таблицу после правки без изменения ширины      |
| `Fit Table Width to Editor`                    | Подгоняет текущую таблицу под видимую ширину редактора                   |
| `Auto Fit Table Width to Editor`               | Автоматически подгоняет таблицу после правки и изменения ширины редактора |
